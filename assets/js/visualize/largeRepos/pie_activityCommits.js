...
function draw_pie_commits(areaID) {
    ...
    function drawGraph(data, areaID) {
        var graphHeader = 'Commits Over 12 Months';
        ...
        var margin = { top: 8, right: 8, bottom: 8, left: 8 },
            ...
            containerWidth = Math.min(element.offsetWidth, 450),
            width = containerWidth - margin.left - margin.right,
            height = containerWidth - margin.top - margin.bottom,
            radius = d3.min([width - margin.left - margin.right, width - margin.top - margin.bottom]) / 2,
            donutWidth = 70;
        ...
        var tip = d3
            ...
            .html(function(d) {
                ...
                return d.data.count.toLocaleString() + units + '<br>' + d.data.label;
            });
        ...
        const textArray = [{ text: graphHeader, class: 'graphtitle', x: 0, y: 0 }, { text: dataTotalCount.toLocaleString(), class: 'graphtitle bignum', x: 0, y: -25 }];
